function becas(){
    ...
    do {
         ...
         //seguridad
         //Utilizar switch para comprobaciones es un marrón!!
         //if / if else/ else if le da 20 patadas

         switch (true) {
             case checkIng.data1:
                 
             edad = prompt("Escriba SÓLO números");
             ...
             case checkIng.data2:
                ...
                alert("No puedo comprobar su edad. Puede perder la beca");
        ...
        ((edad !== isNaN))                                 ? alert('Lo sentimos, no podemos comprobar su edad. Queda fuera del proceso') :
